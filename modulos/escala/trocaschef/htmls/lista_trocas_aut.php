                        ...
                        <div class="panel-group" id="panel-infos-<?php echo $t['id']; ?>">
                            ...
                            if ($t['status'] < 3) {
                                ...
                                <div class="row col-xs-12">
                                    ...
                                    <?php
                                    if ($cor != 'danger') {
                                        $obrigatorio = $cor == 'warning' ? 0 : 0;//definir a obrigatoriedade do comentario do chefe
                                        ?>
                                        <div class="col-xs-11">
                                            <button class="btn btn-success pull-right" onclick="autorizarTroca(<?php echo $t['id']; ?>, <?php echo $obrigatorio; ?>);">
