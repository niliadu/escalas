<div class="row col-xs-6">
    ...
    if (empty($trocas)) {
        ...
        <div class="alert alert-info" >
            <h5><b>Não existem trocas em análise.</b></h5>
        </div>
        <?php
    } else {
        foreach ($trocas as $t) {

            $resp1 = analisarTroca(true, $grupo, $t['usuPE'], $t['escalaPE'], $t['diaPO'], $t['tipo'], $t['diaPE'], $t['turnoPE'], $t['turnoPO'], $t['turnoLegPE'], $t['escalaLegPE'], $t['turnoLegPO'], $t['escalaPO'], $t['usuPO']);
            $corErro[] = $resp1['corErro'];
            $textoErroPE = $resp1['textoErro'];

            $resp2 = analisarTroca(true, $grupo, $t['usuPO'], $t['escalaPO'], $t['diaPE'], $t['tipo'], $t['diaPO'], $t['turnoPO'], $t['turnoPE'], $t['turnoLegPO'], $t['escalaLegPO'], $t['turnoLegPE'], $t['escalaPE'], $t['usuPE']);
                        ...
                        <div class="panel-group" id="panel-infos-<?php echo $t['id']; ?>">
                            ...
                            if ($t['status'] < 3) {
                                ...
                                <div class="row col-xs-12">
                                    <br>
                                    <button class="btn btn-danger  pull-right" onclick="excluirTroca(<?php echo $t['id']; ?>);"><span class="glyphicon glyphicon-remove"></span></button>
                                </div>
                                <?php
                            }
                            ?>
